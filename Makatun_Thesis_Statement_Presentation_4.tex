...
\subsection{}
\begin{frame}\frametitle{Case 1: Example}
...
\begin{frame}\frametitle{Distributed resource management system (RMS): Architecture (Globus example)}
\begin{block}{}
		\begin{itemize}
