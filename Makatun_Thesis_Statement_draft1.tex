...
%In addition to planning of data production, caching algorithms for user analysis were studied. The most widely used known algorithms were compared in multiple series of simulations usign data acess patterns extracted from log systems of two distinct experiments.
